...
***3)*** I exported the meta data, and I then filtered for runs with 200Mbp to 500Mbp of 200 bp spots (and then for the 200 smallest .bam files, for running on my local computer)
