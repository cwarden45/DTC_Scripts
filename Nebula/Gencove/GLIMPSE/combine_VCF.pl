...
my $sample_name = "GLIMPSE.down10.STITCH";
my $VCF_Individual = "Nebula_down10/GLIMPSE_imputed/CW_Nebula-down10_merged-for_CW.vcf";
my $VCF_prev = "../STITCH_Gencove/1000_genomes_20140502_plus_2-SNP-chip_hg38.vcf";
my $VCF_Combined = "1000_genomes_20140502_plus_2-SNP-chip_plus_Nebula-GLIMPSE-down10.vcf";
my $prev_ped = "../STITCH_Gencove/1000_genomes_20140502_plus_2-SNP-chip.ped";
my $updated_ped = "1000_genomes_20140502_plus_2-SNP-chip_plus_Nebula-GLIMPSE-down10.ped";
my $GATK4_flag = 0;
my $large_flag = 0;
...
while (<INPUTFILE>){
	...
	if(!($line =~ /^#/)){
		...
		#I can't check the "PASS" status for the GLIMPSE imputations
