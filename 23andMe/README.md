...
**5)** I might be kind of nit-picky, but I think the "elite" athelete result should probably at least be re-worded.  For example, as described in the report and reiterated (partially) in [this tweet](https://twitter.com/cwarden45/status/1124073546773348354), most people have the "elite" athelete "C" allele.
...
Nevertheless, if anybody read those notes in between the time that I figured this out, I apologize for the confusion.
