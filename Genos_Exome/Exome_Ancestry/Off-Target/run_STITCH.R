bam_list = "Genos_Off-Target-flank_50000-bam.txt"
name_list = "Genos_Off-Target-flank_50000-name.txt"
output_prefix = "1KG_IMPUTE2-Genos_Off-Target-flank_50000-REF286"
...
centromere_table = read.table("../../STITCH_Gencove/UCSC_Download_Centromere.txt", head=F, sep="\t")
