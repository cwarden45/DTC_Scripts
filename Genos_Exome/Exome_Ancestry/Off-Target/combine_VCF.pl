...
my $sample_name = "Genos.off_target.flank50000";
my $VCF_Individual = "1KG_IMPUTE2-Genos_Off-Target-flank_50000-for_CW.vcf";
my $VCF_prev = "../../STITCH_Gencove/1000_genomes_20140502_plus_2-SNP-chip.vcf";
my $VCF_Combined = "1000_genomes_20140502_plus_2-SNP-chip_plus_Genos-Off-Target-flank50000-ref286.vcf";
my $prev_ped = "../../STITCH_Gencove/1000_genomes_20140502_plus_2-SNP-chip.ped";
my $updated_ped = "1000_genomes_20140502_plus_2-SNP-chip_plus_Genos-Off-Target-flank50000-ref286.ped";
my $GATK4_flag = 0;
my $large_flag = 0;
