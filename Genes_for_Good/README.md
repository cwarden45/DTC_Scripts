...
I mention this because I would otherwise note that some chromosome painting results seemed like they may be false positives (even though my pie chart was 99% European, and I was clearly in the European cluster in the PCA plot).  For example, [in this blog post](https://cdwscience.blogspot.com/2019/09/examples-of-visual-critical-assessment.html) I believe you can see a likely phasing problem on *my human chromsome 14*, where the African ancestry should only be coming from one of my parents (and this means the smaller segements of European ancestry inbetween could also be imprecise).  However, with this warning, I feel very comfortable with the overall results (and, most importantly, the raw data), particulary given that they were free.
