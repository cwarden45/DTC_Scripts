...
That said, the [8 Pharmacokinetic and 4 Pharmacodynamic Genes](https://genesight.com/product/#product-clinical) listed for GeneSight are a little different than the 12 gene used by Color.  Even among the 2 Color genes used for my Color anti-depressant report, only CYP2C19 (not CYP2D6) overlaps the GeneSight genes.
