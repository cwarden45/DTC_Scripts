...
my $sample_name = "Nebula.full.STITCH.ref99";
my $VCF_Individual = "1KG_IMPUTE2-Nebula_full_nodup-for_CW.vcf";
my $VCF_prev = "../STITCH_Gencove/1000_genomes_20140502_plus_2-SNP-chip.vcf";
my $VCF_Combined = "1000_genomes_20140502_plus_2-SNP-chip_plus_Nebula-STITCH-full-ref99.vcf";
my $prev_ped = "../STITCH_Gencove/1000_genomes_20140502_plus_2-SNP-chip.ped";
my $updated_ped = "1000_genomes_20140502_plus_2-SNP-chip_plus_Nebula-STITCH-full-ref99.ped";
my $GATK4_flag = 0;
my $large_flag = 0;
